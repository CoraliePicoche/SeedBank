...
plot(1:length(mean_tmp),rep(NA,length(mean_tmp)),ylim=c(4,6),ylab="Log10(total abundance)",xlab="",xaxt="n",xlim=c(0.8,length(mean_tmp)+0.5),cex.axis=1.5,cex.lab=1.5)
mtext("b",line=0.2,at=.75,cex=1.3,font=2)
for(m in 1:2){
	if(m==1){
		acol="black"
		shift=0
