...
plot(a,surviv_compet[,1],t="p",col="black",xlab="Growth low density",pch=16,ylim=c(0,1),ylab="Prob survival",cex=1.5,xlim=limits+c(-0.1,0.1))
...
plot(a,surviv_compet[,1],t="p",col="black",xlab="Growth average density",pch=16,ylim=c(0,1),ylab="",cex=1.5,xlim=limits+c(-0.1,0.1))
points(a[questionning],surviv_compet[questionning,1],col="red",pch=16)
...
plot(a,surviv_compet[,1],t="p",col="black",xlab="Growth optimal temperature",pch=16,ylim=c(0,1),ylab="Prob survival",cex=1.5,xlim=limits+c(-0.1,0.1))
points(a[questionning],surviv_compet[questionning,1],col="red",pch=16)
...
plot(a,surviv_compet[,1],t="p",col="black",xlab="Growth bad temperature",pch=16,ylim=c(0,1),ylab="",cex=1.5,xlim=limits+c(-0.1,0.1))
points(a[questionning],surviv_compet[questionning,1],col="red",pch=16)
