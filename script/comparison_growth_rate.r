...
legend("topleft",c("SV","SV corrected, A=15","low T_opt SV corrected","high T_opt SV corrected","Bissinger","Eppley","Literature"),lty=c(1,1,3,3,2,2,1),lwd=c(3,3,3,3,2,1,1,1),bty="n",col=c("grey","black","blue","red","black","black","orchid","black"))
dev.off()
