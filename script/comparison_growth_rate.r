...
plot(seq_temp-273,val_growth_SV_init,ylim=c(0,2),t="l",lwd=3,xlab="Temperature",ylab="Growth rate (d-1)",xlim=c(0,30),col="grey")
...
legend(0,1.75,c("SV","SV corrected","low T_opt SV","high T_opt SV","Bissinger","Literature"),lty=c(1,1,3,3,2,1),lwd=c(3,3,3,3,2,1,1),bty="n",col=c("grey","black","blue","red","black","black","black"))
dev.off()
