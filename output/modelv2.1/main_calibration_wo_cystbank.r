...
###CP 30/08/2021: Tried the same estimation process without a seed bank
#################
...
write.table(inter_mat[[2]],paste("interaction_matrix_before_calibration_wo_bank.csv",sep=""),sep=";",row.names=F,dec=".")
...
write.table(final_summary,"summary_statistics_per_species_before_calibration_test_on_original_wo_bank.txt",dec=".",sep=";")
...
#Write simulations
write.table(tab_simu,paste("list_simulation_calibration_wo_bank.csv",sep=""),sep=";",dec=".")
...
write.table(tab_summary_tmp,paste("list_statistics_calibration_wo_bank.csv",sep=""),sep=";",dec=".")
...
rownames(final_summary)=names(final_summary_tmp[[1]])
colnames(final_summary)=colnames(tab_summary)[1:3]
write.table(final_summary,"summary_statistics_per_species_after_calibration_wo_bank.txt",dec=".",sep=";")
...
write.table(list_H_tmp[[1]],"interaction_matrix_after_calibration_wo_bank.csv",sep=";",dec=".")
write.table(type_inter[[1]],"facilitation_and_competition_wo_bank.csv",sep=";",dec=".")


write.table(N[,1,],paste("out_coast_wo_bank.csv",sep=""),sep=";",dec=".")
write.table(N[,2,],paste("out_ocean_wo_bank.csv",sep=""),sep=";",dec=".")
write.table(N[,3,],paste("out_seed_wo_bank.csv",sep=""),sep=";",dec=".")
