...
###CP 30/09/2021: Trying the calibration without cyst bank
#################
...
############
M=1 ###We remove the cyst bank as is done in the other simulations!!
############
...
write.table(inter_mat,paste("interaction_matrix_before_calibration_wo_bank.csv",sep=""),sep=";",row.names=F,dec=".")
...
write.table(final_summary,"summary_statistics_per_species_before_calibration_wo_bank.txt",dec=".",sep=";")
...
#Matrix
write.table(tmp_inter,"interaction_matrix_after_calibration_wo_bank.csv",sep=";",dec=".")
