...
\begin{scope}
   ...
   \node [circle,draw=white,fill=white,minimum size=6mm,right of=sp2_v,node distance=1in](sp_etc){\Huge ...}; %all other species
    ...
    %Interactions
       ...
       \path[->]          (sp1_v)  edge   [bend left=20]   node [above] {$\alpha_{21}$} (sp2_v);
               ...
               \path[->]          (sp2_sea)  edge   [bend left=20]   node [below] {$\alpha_{12}$} (sp1_sea);
  ...
  \draw[thick,->,postaction={decorate,decoration={text along path, raise=5pt,text={{$r_{2}(T)$}{}},text align=center}}] (sp2_v) to [looseness=4, out=90,in=0] (sp2_v);
     \draw[thick,->,postaction={decorate,decoration={text along path, raise=5pt,text={{$r_{2}(T)$}{}},text align=center}}] (sp2_sea) to [looseness=4, out=90,in=0] (sp2_sea);
          \draw[thick,->,postaction={decorate,decoration={text along path, raise=5pt,text={{$r_{1}(T)$}{}},text align=center}}] (sp1_sea) to [looseness=4, out=270,in=180] (sp1_sea);
          
       %cyst mortality   
\draw[thick,->,postaction={decorate,decoration={text along path, raise=5pt,text={{$(1-m)$}{}},text align=center, reverse path}}] (sp1_r) to [looseness=4, out=180,in=270] (sp1_r);
\draw[thick,->,postaction={decorate,decoration={text along path, raise=5pt,text={{$(1-m)$}{}},text align=center}}] (sp2_r) to [looseness=4, out=0,in=270] (sp2_r);
