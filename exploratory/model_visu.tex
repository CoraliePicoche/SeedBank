...
\begin{scope}
  ...
  \draw[thick,->,postaction={decorate,decoration={text along path, raise=5pt,text={{$r_{2}(T)$}{}},text align=center}}] (sp2_v) to [looseness=4, out=90,in=0] (sp2_v);
     \draw[thick,->,postaction={decorate,decoration={text along path, raise=5pt,text={{$r_{2}(T)$}{}},text align=center}}] (sp2_sea) to [looseness=4, out=90,in=0] (sp2_sea);
       ...
       %cyst mortality   
\draw[thick,->,postaction={decorate,decoration={text along path, raise=-8pt,text={{$(1-m)$}{}},text align=center}}] (sp1_r) to [looseness=4, out=180,in=270] (sp1_r);
\draw[thick,->,postaction={decorate,decoration={text along path, raise=-8pt,text={{$(1-m)$}{}},text align=center,reverse path}}] (sp2_r) to [looseness=4, out=0,in=270] (sp2_r);
